<script setup>
  ...
  const getUrl = name => {return new URL(`../assets/img/goods/${name}`, import.meta.url)}
</script>
  ...
  <section class="products">
    ...
    <div class="products-card__description-row">
      <div class="products-wrapper" id="good-container">
        <div class="products-card" v-for="goods in goodArray" :key="goods.id">
          <div class="products-card__image">
            <img :src="getUrl(goods.image)" :alt="`${goods.image}`">
          </div>
          <div class="products-card__description">
            <div class="products-card__description-row">
              <h5 class="products-card__description--name">{{ goods.name }}</h5>
            </div>
            <div class="products-card__description-row">
            ...
            <div class="products-card__description-row">
              <div class="products-card__description-controls">
                <button class="button button-main open-btn" @toggleModal="store.toggleModal(true)">
